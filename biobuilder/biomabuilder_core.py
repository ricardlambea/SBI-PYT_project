...
# if len(list(final_model[0].get_chains())) > 62: #para ver si funciona el cif
#     for chain in final_model[0].get_chains():
#         newchain.id = str(chain.id)
...
if os.path.exists(args.output_directory): # Checks out if output_directory exists
    ...
    os.system("mv" + " " + "../biomabuilder/alignments-" + args.out_name + ".txt" + " " + "./alignments-" + args.out_name + ".txt")
    if args.verbose:
