import argparse
from biobuilder_functions import *

########################## DEALING WITH ARGUMENTS ##########################
dealer = argparse.ArgumentParser(description =
            "BioBuilder is a program for modelling the macro-complex structure of biomolecules formed by proteins and DNA/RNA, starting with each pairing interaction of a complex: protein-protein, protein-DNA/RNA", epilog = " BioBuilder. Universidad Pompeu Fabra. MSc Bioinformatics for Health Sciences. 2020. Ricard Lambea-Jane, Carolina Hernandez-Oliver, JV Roig-Genoves")
...
if args.output_directory: # Checks out if output_directory argument has been defined
